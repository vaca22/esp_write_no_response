...
static const ble_uuid128_t gatt_read_uuid =
        BLE_UUID128_INIT(0xf6, 0x6d, 0xc9, 0x07, 0x71, 0x00, 0x16, 0xb0,
                         0xe1, 0x45, 0x7e, 0x89, 0x9e, 0x65, 0x3a, 0x5c);

/* 5c3a659e-897e-45e1-b016-007107c96df7 */
static const ble_uuid128_t gatt_notify_uuid =
...
static const struct ble_gatt_svc_def gatt_svr_svcs[] = {
        {
                ...
                .characteristics = (struct ble_gatt_chr_def[]) {{
                                                                        ...
                                                                        .uuid = &gatt_read_uuid.u,
                                                                        .access_cb = gatt_svr_chr_access_sec_test,
                                                                        .flags = BLE_GATT_CHR_F_WRITE_NO_RSP,
                                                                },
                                                                {
                                                                        /*** Characteristic: Static value. */
                                                                        .uuid = &gatt_notify_uuid.u,
                                                                        .access_cb = gatt_svr_chr_access_sec_test,
...
gatt_svr_chr_access_sec_test(uint16_t conn_handle, uint16_t attr_handle,
    ...
    if (ble_uuid_cmp(uuid, &gatt_read_uuid.u) == 0) {
    ...
    if (ble_uuid_cmp(uuid, &gatt_notify_uuid.u) == 0) {
        switch (ctxt->op) {
...
void init_ble(void) {
    ...
    ble_svc_gap_device_name_set("wsSnake");
